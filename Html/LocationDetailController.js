app.controller('locationDetailController', ['$rootScope', '$scope', '$location', '$routeParams', '$route', '$http', 'DetailService',
    function ($rootScope, $scope, $location, $routeParams, $route, $http, detailService) {
        $scope.detailService = detailService;
        $scope.myDetailLocation = $scope.detailService.location;
        console.log($scope.myDetailLocation );
        ...
        console.log($scope.myDetailLocation.locEvents);
